...
```{r, echo=FALSE}
PeakCommunity + theme_grey(base_size = 10) + theme(legend.title=element_blank()) + ggtitle("...")
```
...
```{r, echo=FALSE}
PeakFounctionalGroup + theme_grey(base_size = 5) + theme(legend.title=element_blank()) + ggtitle("...")
```

## Compare the treatments

```{r, echo=FALSE}
firstbudSpecies + theme_grey(base_size = 5) + theme(legend.title=element_blank()) + ggtitle("...")
```
...
- Calculate phenology in temperaure sum
- ...
